...
def generate_launch_description():
    ...
    # Setup project paths
    pkg_project_bringup = get_package_share_directory('meu_pacote4')
    pkg_project_gazebo = get_package_share_directory('meu_pacote4')
    pkg_project_description = get_package_share_directory('meu_pacote4')
